                    ...
                    <tr style="text-align: center;">
                      ...
                      <td><?= $ds['email']; ?></td>
                        <td>
                          ...
                          <a href="ubah_siswa.php?id_siswa=<?= $ds['id_siswa']; ?>" class="badge badge-success" data-toggle="modal" data-target="#editSiswa<?= $ds['id_siswa']; ?>" style="text-align: center;">
                            <i class="fas fa-fw fa-edit"></i> Edit
                          </a>
                          <!-- Modal -->
                          <div class="modal fade" id="editSiswa<?= $ds['id_siswa']; ?>" tabindex="-1" role="dialog" aria-labelledby="editSiswa<?= $ds['id_siswa']; ?>" aria-hidden="true" style="text-align: left;">
                            <div class="modal-dialog" role="document">
                              <form method="post">
